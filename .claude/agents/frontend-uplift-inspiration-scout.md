...
Before doing anything else, read `.claude/agent-memory/frontend-uplift-inspiration-scout/lessons.md` if it exists.
...
`.claude/agent-memory/frontend-uplift-inspiration-scout/lessons.md`. Return
